...
var questions = [
    ...
    'Do you have Fatigue?',
    'Have you travelled in a Month (Overseas)?',
    'Have you come in contact with a Covid-19 positive patient ?',
...
function showResponse() {
    ...
    if (inputBox.value == "") {
        ...
        if (num==13) {
            ...
            if (num2>7) {
                output.innerHTML = 'There is a high tendency of you having Covid-19.</br> please '+questions[13];
            }else{
